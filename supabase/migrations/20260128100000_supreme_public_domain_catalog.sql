...
-- Cultural & Historical
('black-cinema', 'theme', 'Black-led and culturally significant films'),
('civil-rights', 'theme', 'Civil rights era documentaries and films'),
('african-american-history', 'theme', 'African American historical content'),
('harlem-renaissance', 'era', 'Harlem Renaissance era (1920s-1930s)'),
('race-films', 'style', 'Independent Black films (1910s-1950s)'),
('blaxploitation', 'style', 'Blaxploitation era films (1970s)'),

-- Genre Tags
('film-noir', 'genre', 'Dark, atmospheric crime dramas'),
('silent-film', 'genre', 'Silent era cinema (pre-1930)'),
('horror', 'genre', 'Horror and thriller films'),
('sci-fi', 'genre', 'Science fiction films'),
('western', 'genre', 'Western films'),
('comedy', 'genre', 'Comedy films'),
('drama', 'genre', 'Drama films'),
('documentary', 'genre', 'Documentary films'),
('animation', 'genre', 'Animated films and shorts'),
...
('seventies', 'era', '1970s cinema'),
('sixties', 'era', '1960s cinema'),
('fifties', 'era', '1950s cinema'),
('forties', 'era', '1940s cinema'),
('thirties', 'era', '1930s cinema'),
('twenties', 'era', '1920s cinema'),
('silent-era', 'era', 'Silent film era (pre-1930)'),

-- Style Tags
('public-domain', 'style', 'Public domain content'),
('archive-org', 'style', 'Internet Archive content'),
...
('fast-channel', 'style', 'FAST provider content'),
('indie', 'style', 'Independent films'),
('avant-garde', 'style', 'Experimental and avant-garde films'),
...
('family', 'theme', 'Family-friendly content'),
('educational', 'theme', 'Educational content'),
('propaganda', 'theme', 'Historical propaganda films'),

-- Content Tags  
('classic', 'style', 'Classic cinema'),
('restored', 'style', 'Digitally restored films'),
('shorts', 'style', 'Short films'),
('series', 'style', 'Television series'),
('feature-film', 'style', 'Full-length feature films'),
('trending', 'topic', 'Currently trending content')
