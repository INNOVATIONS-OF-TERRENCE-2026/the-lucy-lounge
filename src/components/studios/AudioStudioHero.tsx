  ...
  return (
    <div className="text-center mb-16 max-w-5xl mx-auto">
      <div className="mb-8 flex justify-center">
        <LucyAvatar size="lg" state="excited" className="drop-shadow-2xl" />
      </div>
      ...
      <p className="text-xl md:text-2xl text-white/90 mb-8 text-shadow-soft">
        Express Audio Power — inside Lucy.
      </p>

      <p className="text-lg text-white/80 max-w-3xl mx-auto">
        Create, transform, and explore audio with the next-generation
        AI-powered sound workstation.
      </p>
    </div>
  );
};
