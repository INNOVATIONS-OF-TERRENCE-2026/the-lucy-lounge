...
const Dreamveil = memo(() => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(135deg, hsl(260 50% 60% / 0.2) 0%, hsl(300 40% 70% / 0.2) 50%, hsl(280 45% 55% / 0.2) 100%)",
      }}
...
const QuantumRift = memo(() => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <motion.div
      ...
      style={{
        background:
          "conic-gradient(from 0deg at 50% 50%, hsl(180 70% 50% / 0.1) 0deg, hsl(320 60% 55% / 0.1) 180deg, hsl(180 70% 50% / 0.1) 360deg)",
      }}
