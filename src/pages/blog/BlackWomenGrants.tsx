...
const BlackWomenGrants = () => {
  ...
  const relatedLinks = [
    ...
    { title: 'WOSB Certification Guide', url: '/blog/wosb-certification-guide', type: 'cluster' as const },
          ...
          <div className="flex gap-8">
            ...
            <aside className="hidden lg:block w-80">
              <div className="sticky top-8">
                <RelatedGuides links={relatedLinks} currentPath="/blog/black-women-entrepreneur-grants" />
              </div>
            </aside>
          </div>
        </div>
