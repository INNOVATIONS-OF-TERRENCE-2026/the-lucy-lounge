...
const SBABadCredit = () => {
  ...
  const relatedLinks = [
    ...
    { title: 'SBA 7(a) vs 504 Comparison', url: '/blog/sba-7a-vs-504-loans', type: 'cluster' as const },
          ...
          <div className="flex gap-8">
            ...
            <aside className="hidden lg:block w-80">
              <div className="sticky top-8">
                <RelatedGuides links={relatedLinks} currentPath="/blog/sba-loan-with-bad-credit" />
              </div>
            </aside>
          </div>
        </div>
