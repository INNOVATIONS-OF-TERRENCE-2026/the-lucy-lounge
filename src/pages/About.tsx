...
/**
 * About Lucy Page
 * Contains SEO, structured data, hero sections, and visual layering fixes.
 */
const About = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative overflow-hidden bg-background">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-background/70 pointer-events-none z-[1]" />
        ...
        <div className="relative z-[5]">
          ...
          <section className="relative py-20 px-4">
            <div className="relative z-10 max-w-3xl mx-auto glass-card-enhanced p-12 text-center shadow-glow-violet">
              <h2 className="text-3xl font-bold text-foreground mb-4">Experience Lucy AI</h2>
              <p className="text-foreground/80 mb-8 text-lg">
                Start your journey with a digital companion designed with purpose, precision, and creativity.
              </p>
              <Button
                size="lg"
