...
const ListeningMode = () => {
  ...
  const filteredSmoothRap = useMemo(
    () => filterItems(filterByMood(smoothRapContent, "smooth-rap")),
  ...
  const filteredAmbient = useMemo(
    () => filterItems(filterByMood(ambientContent, "ambient")),
    [searchQuery, activeMood],
  );
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Music discovery, vibes & inspiration</p>
              </div>
            </div>
          </div>
